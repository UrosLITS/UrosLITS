...
class AddChapterDialog extends StatefulWidget {
  ...
  _AddChapterDialog createState() => _AddChapterDialog();
}

class _AddChapterDialog extends State<AddChapterDialog> {
  final _formKey2 = GlobalKey<FormState>();
  late String newChapterTitle;
